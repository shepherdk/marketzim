                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Article Details</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="/">Home</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">Article details</span>
                            </nav>
                        </div>
                    </div>
                </div>
        						...
        						<div class="col-lg-6 col-12">
        							<div class="wn__fotorama__wrapper">
	        							<div class="fotorama wn__fotorama__action" data-nav="thumbs">
		        							  ...
		        							  <a href="5.jpg"><img src="{{ asset('images/product/5.jpg') }}" alt=""></a>
		        							  <a href="6.jpg"><img src="{{ asset('images/product/6.jpg') }}" alt=""></a>
		        							  <a href="7.jpg"><img src="{{ asset('images/product/7.jpg') }}" alt=""></a>
		        							  <a href="8.jpg"><img src="{{ asset('images/product/8.jpg') }}" alt=""></a>
	        							</div>
        							</div>
        						</div>
        						<div class="col-lg-6 col-12">
        							<div class="product__info__main">
                                        <h1>{{ $article->title }}</h1>
                                        <p class="text-muted">Article by {{ $article->user->name}}</p>
