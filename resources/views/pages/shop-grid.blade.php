	        					...
	        					<div class="row">
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product">Animals Life</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product">Olio Madu</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product">Soad Humber</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product">War Of Dragon</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product">New World</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center content--center">
											<h4><a href="single-product">Our World</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
	        				...
	        				<div class="shop-grid tab-pane fade" id="nav-list" role="tabpanel">
	        					<div class="list__view__wrapper">
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product">Blood In Water</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product">Madeness Overated</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product">Watching You</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        						...
	        						<div class="list__view mt--40">
	        							...
	        							<div class="content">
	        								<h2><a href="single-product">Court Wings Run</a></h2>
	        								<ul class="rating d-flex">
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
	        									<li class="on"><i class="fa fa-star-o"></i></li>
